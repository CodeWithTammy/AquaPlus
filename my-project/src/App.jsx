// Built and developed by Tamera Anderson
  ...
  return (
      ...
      <div className="overflow-x-hidden">
        ...
        <button
          ...
          onClick={scrollToTop}
          className={`fixed w-16 h-16 z-[9999] bottom-10 right-10 bg-secondbasecolor text-white flex justify-center items-center shadow-lg animate-bounce rounded-full transition-opacity duration-300 ${visible ? "opacity-100" : "opacity-0"}`}
        >
