...
const AdminServiceRequest = () => {
  ...
  useEffect(() => {
    ...
    fetch(`${import.meta.env.VITE_API_URL}/api/requestservices`)
      .then((res) => res.json())
  ...
  const toggleStatus = async (id) => {
    ...
    try {
      await fetch(`${import.meta.env.VITE_API_URL}/api/requestservices/${id}`, {
        method: "PATCH",
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const res = await fetch(`${import.meta.env.VITE_API_URL}/api/requestservices/${id}`, { method: "DELETE" });
