...
const About = () => {
  return (
    <div className='w-full h-[40rem] mb-20 sm:mb-32 flex flex-col items-center justify-center text-center'>
      <Motion.div
        ...
        <div className="flex flex-col md:flex-row items-center justify-between px-8 py-12 bg-white gap-12">
          ...
          <div className="max-w-xl text-center md:text-left">
            <p className="text-blue-600 font-semibold mb-2">
              <span className="inline-block w-1 h-3 bg-blue-600 mr-1"></span>About Us
            </p>
